...
export default useFetch = (endpoint, query) => {
	...
	useEffect(() => {
		if (endpoint == "search") {
			setData(static_data.data);
		} else if (endpoint.includes("job-details")) {
			setData(
				[static_data.data[
					Math.floor(Math.random() * static_data.data.length) + 1
				]]
			);
		}
	}, []);
...
// 		params: { ...query },
// 		headers: {
// 			"X-RapidAPI-Key": "44155929camsh0337f84d886920dp19ecb3jsn726a4d853148",
